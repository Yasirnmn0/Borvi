...
export default function HowValueStrip() {
  return (
    <section className="w-full  px-10 bg-[#f6f6f6] overflow-hidden">
      <motion.div
        variants={fadeUp}
        initial="hidden"
        whileInView="show"
        viewport={{ once: true }}
        className="w-full rounded-[24px] bg-[#f7f9f7] border border-neutral-100 py-8 px-6 lg:px-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-y-8 lg:gap-y-0 items-center"
      >
        <motion.div
              ...
              >
                ...
                <div className="flex items-center gap-4 px-2 sm:px-4 w-full">
                  ...
                  <motion.div
                    ...
                    className="w-14 h-14 rounded-full bg-[#e7f2ec] text-[#032f19] flex items-center justify-center shrink-0"
                  >
