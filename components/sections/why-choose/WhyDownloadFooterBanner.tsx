    ...
    <section className="bg-[#f6f6f6] overflow-hidden">
      ...
      <div className="w-full max-w-7xl mx-auto px-10 pb-10">
        ...
        <motion.div
          ...
          whileInView="show"
          viewport={{ once: true }}
          className="relative overflow-hidden rounded-2xl px-8 py-6 bg-gradient-to-r from-[#063d2a] to-[#0c7a4b] text-white flex items-center justify-between gap-8"
        >
          {" "}
          {/* LEFT: PHONE */}{" "}
          <motion.div
          ...
          <motion.div variants={fadeUp} className="flex-1">
            {" "}
            <h3 className="text-4xl sm:text-xl font-bold tracking-tight">
              {" "}
              Rent Anytime, Anywhere{" "}
            </h3>{" "}
            <p className="text-lg sm:text-sm text-neutral-300 mt-1 font-medium">
              {" "}
              Download our app and explore 1500+ equipment at your
              fingertips.{" "}
            </p>{" "}
          </motion.div>{" "}
          {/* RIGHT */}{" "}
